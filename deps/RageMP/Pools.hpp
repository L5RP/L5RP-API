...
namespace rage
{
    ...
    public:
        ...
        virtual void BroadcastInRange(
            ...
            float range,
            dimensionId_t dimension = 0xFFFFFFFF
        ) const = 0;
    ...
    public:
        ...
        virtual void _CallInDimension(
            dimensionId_t dimension,
            const std::string& eventName,
            const arg_t* arguments = nullptr,
            size_t count = 0
        ) const = 0;
        virtual void _CallFor(
            const std::vector<rage::IPlayer*>& players,
            const std::string& eventName,
            const arg_t* arguments = nullptr,
            size_t count = 0
        ) const = 0;
        ...
        virtual void _InvokeInDimension(
            dimensionId_t dimension,
            uint64_t nativeHash,
            const arg_t* arguments = nullptr,
            size_t count = 0
        ) const = 0;
        virtual void _InvokeFor(
            const std::vector<rage::IPlayer*>& players,
            uint64_t nativeHash,
            const arg_t* arguments = nullptr,
            size_t count = 0
    ...
    public:
        ...
        virtual IColshape* NewTube(
            const vector3& position,
            float radius,
            float height,
            dimensionId_t dimension = 0
        ) const = 0;
        virtual IColshape* NewRectangle(
    ...
    {
    public:
        virtual ITextLabel* New(
            const vector3& pos,
            const std::string& text,
            uint8_t fontId,
            rage::rgba_t color,
            float drawDistance = 150.f,
            bool los = false,
            dimensionId_t dimension = 0
        ) const = 0;
    };
