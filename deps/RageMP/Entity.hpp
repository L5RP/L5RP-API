...
#pragma pack(push, 1)
    ...
    public:
        ...
        arg_t(entity_t entityType, entityId_t id, rage::IEntity* entity)
            : type(val_t::Entity),
              v{entityType, id, entity} {}

        arg_t(const arg_t& r)
            : type(val_t::Null) { *this = r; }
        ...
        {
            if(type == val_t::Vector3) { return v.vector; }
            else {
                static vector3 ret;
                return ret;
            }
...
#pragma pack(pop)
    ...
    public:
        ...
        GetInRange(vector3 position, float range, dimensionId_t dimension = 0xFFFFFFFF) const = 0;
        ...
        public:
            ...
            iterator(pointer ptr, uint32_t rest)
                : ptr_(ptr),
                  rest_(rest - 1)
            {
                if(*ptr == nullptr)
