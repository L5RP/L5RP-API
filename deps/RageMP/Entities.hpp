...
namespace rage
{
    ...
    public:
        ...
        virtual void
        _CallHash(uint64_t eventNameHash, const arg_t* arguments = nullptr, size_t count = 0) = 0; // xxhash64
    ...
    public:
        ...
        virtual void
        PlayAnimation(const std::string& dict, const std::string& name, float speed = 8.f, int flags = 0) = 0;
        ...
        virtual void SetCustomization(
            ...
            const std::vector<std::pair<uint32_t, uint32_t>> decorations
        ) = 0;
        ...
        virtual void SetHeadBlend(
            int shapeFirstID, int shapeSecondID, int shapeThirdID, int skinFirstID, int skinSecondID,
            int skinThirdID,
